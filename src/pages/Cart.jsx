            ...
            <div className="flex gap-4">
                ...
                <div className="outline outline-black/10 p-3 mt-6 rounded-xl flex flex-col gap-2 w-[30%] h-fit">
                    ...
                    <ul className="border-y border-gray-200 py-4 my-1">
                        <li className="flex justify-between my-2"><span className="text-black/40">Items</span> <span>9</span></li>
                        <li className="flex justify-between my-2"><span className="text-black/40">Sub Total</span> <span>$740.00</span></li>
                        ...
                        <li className="flex justify-between my-2"><span className="text-black/40">Coupon Discount</span> <span>-$100.00</span></li>
                    </ul>
                        <p className="flex justify-between my-2"><span className="text-black/40">Total</span> <span>$100.00</span></p>
