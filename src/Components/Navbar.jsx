...
const Navbar = () => {
    ...
    return(
        <div className="flex justify-center items-center">
            ...
            <div className={ isOpen ? "rounded-t-4xl w-full max-w-6xl mx-auto flex justify-between py-3 px-4 bg-neutral-50 items-center md:rounded-4xl absolute top-3 z-10  " : "w-full max-w-6xl mx-auto flex justify-between py-3 px-4 bg-neutral-50 items-center rounded-4xl absolute top-3 z-10  "}>
